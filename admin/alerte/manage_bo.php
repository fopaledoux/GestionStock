...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title"><?php echo isset($id) ? "Détails du bon de commande- ".$po_code : 'Créer un nouveau bon de commande' ?></h4>
    </div>
    <div class="card-body">
        <form action="" id="po-form">
            ...
            <div class="container-fluid">
                ...
                <table class="table table-striped table-bordered" id="list">
                    ...
                    <tfoot>
                        <tr>
                            <th class="text-right py-1 px-2" colspan="5">Montant brut</th>
