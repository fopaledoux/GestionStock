...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">Commande différée Details - <?php echo $bo_code ?></h4>
    </div>
    <div class="card-body" id="print_out">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <label class="control-label text-info">From Code bon de commande</label>
            ...
            <h4 class="text-info">Détails de la commande</h4>
            <table class="table table-striped table-bordered" id="list">
                ...
                <thead>
                    <tr class="text-light bg-navy">
                        <th class="text-center py-1 px-2">Qte</a>
                        <th class="text-center py-1 px-2">Unité</a>
                        <th class="text-center py-1 px-2">Article</a>
                        <th class="text-center py-1 px-2">Cout</a>
                ...
                <tfoot>
                    <tr>
                        <th class="text-right py-1 px-2" colspan="4">Montant brut</th>
                    ...
                    <tr>
                        <th class="text-right py-1 px-2" colspan="4">Net a payer</th>
            ...
            <div class="row">
                ...
                <?php if($status > 0): ?>
                <div class="col-md-6">
                    <span class="text-info"><?php echo ($status == 2)? "RECU" : "PARTIELLEMENT REÇU" ?></span>
                </div>
                <?php endif; ?>
            </div>
        </div>
    ...
    $(function(){
        $('#print').click(function(){
            ...
            var _head = $('head').clone()
                _head.find('title').text("Détails du bon de commande- Apercu avant impression")
            ...
            _el.append('<div class="d-flex justify-content-center">'+
                      ...
                      '<h4 class="text-center">Stock en rupture</h4>'+
                      '</div>'+
                      '<div class="col-1 text-right">'+
                      '</div>'+
                      '</div><hr/>')
