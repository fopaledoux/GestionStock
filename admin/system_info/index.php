...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		<div class="card-header">
			<h5 class="card-title">Systeme d'information</h5>
		...
		<div class="card-body">
			...
			<div class="form-group">
				<label for="name" class="control-label">Nom de l'entreprise</label>
				<input type="text" class="form-control form-control-sm" name="name" id="name" value="<?php echo $_settings->info('name') ?>">
			</div>
			<div class="form-group">
				<label for="short_name" class="control-label">Abbreviation nom entreprise</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Logo de l'entreprise</label>
		...
		<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-primary" form="system-frm">Mise a jour</button>
				</div>
			</div>
		</div>
