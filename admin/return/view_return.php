...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">Information du bon de retour - <?php echo $return_code ?></h4>
    </div>
    ...
    $(function(){
        $('#print').click(function(){
            ...
            var _head = $('head').clone()
                _head.find('title').text("Bon de retour - Apercu avant impression")
            ...
            _el.append('<div class="d-flex justify-content-center">'+
                      ...
                      '<h4 class="text-center">Bon de retour</h4>'+
                      '</div>'+
                      '<div class="col-1 text-right">'+
                      '</div>'+
                      '</div><hr/>')
