...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="?page=user/manage_user" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span> Nouveau utilisateur</a>
		</div>
	</div>
	<div class="card-body">
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td ><p class="m-0"><?php echo ($row['type'] == 1 )? "Administrateur" : "Caissiere" ?></p></td>
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  		Action
				                    <span class="sr-only">Basculer la liste deroulante</span>
				                  </button>
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Etes vous sur de vouloir supprimer cette utilisateur?","delete_user",[$(this).attr('data-id')])
		})
