...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title"><?php echo isset($id) ? "Details sur la Vente - ".$sales_code : 'Enregistrer une nouvelle vente' ?></h4>
    </div>
    <div class="card-body">
        <form action="" id="sale-form">
        <input type="hidden" name="vendeur" value="<?php echo ucwords($_settings->userdata('firstname'))?>">
            ...
            <div class="container-fluid">
                ...
                <hr>
                <fieldset>
                    <legend class="text-info">Articles</legend>
                    <div class="row justify-content-center align-items-end">
                        ...
                        <div class="col-md-2 text-center">
                            <div class="form-group">
                                <button type="button" class="btn btn-flat btn-sm btn-primary" id="add_to_list">Ajouter a la liste</button>
                            </div>
                        </div>
                </fieldset>
                <hr>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-dark" href="<?php echo base_url.'/admin?page=sales' ?>">Annuler</a>
    </div>
</div>
    ...
    $(function(){
        ...
        $('#sale-form').submit(function(e){
			...
			$.ajax({
				...
				error:err=>{
					console.log(err)
					alert_toast("Une erreur s\'est pproduite",'error');
					end_loader();
				},
