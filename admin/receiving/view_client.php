...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">Bon de livraison client- <?php echo $sales_code ?></h4>
    </div>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-dark" href="<?php echo base_url.'/admin?page=receiving&c=1' ?>"> Retour à la liste</a>
    </div>
</div>
    ...
    $(function(){
        $('#print').click(function(){
            ...
            var _head = $('head').clone()
                _head.find('title').text("Bon de livraison - Apercu avant impression")
