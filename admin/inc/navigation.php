              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=alerte" class="nav-link nav-alerte">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=maintenance/rapport" class="nav-link nav-rapport_vente">
                        <i class="nav-icon fas fa-file-invoice-dollar"></i>
                        <p>
                          Rapport de ventes
                        </p>
                   ...
                   <!-- <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=maintenance/rapportachats" class="nav-link nav-rapport_achats">
                        <i class="nav-icon fas fa-file-invoice-dollar"></i>
                        <p>
                          Rapport des achats
                        </p>
