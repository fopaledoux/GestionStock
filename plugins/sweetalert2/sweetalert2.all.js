...
(function (global, factory) {
   ...
   * const {value: firstName} = await Swal.fire({ ...textPromptOptions, title: 'What is your Nom?' })
   * const {value: lastName} = await Swal.fire({ ...textPromptOptions, title: 'What is your Prenom?' })
   *
   * After:
   * const TextPrompt = Swal.mixin({ input: 'text', showCancelButton: true })
   * const {value: firstName} = await TextPrompt('What is your Nom?')
   * const {value: lastName} = await TextPrompt('What is your Prenom?')
   *
   * @param mixinParams
   */
